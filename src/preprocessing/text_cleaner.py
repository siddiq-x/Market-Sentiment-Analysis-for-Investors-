...
class TextCleaner:
    ...
    def _extract_tickers(self, text: str) -> List[str]:
        ...
        false_positives = {'THE', 'AND', 'FOR', 'ARE', 'BUT', 'NOT', 'YOU', 'ALL', 'CAN', 'HER', 'WAS', 'ONE', 'OUR', 'HAD', 'BY', 'UP', 'DO', 'NO', 'IF', 'MY', 'ON', 'AS', 'WE', 'HE', 'BE', 'TO', 'OF', 'IT', 'IS', 'IN', 'AT', 'OR'}
    ...
    def get_cleaning_stats(self, cleaned_texts: List[CleanedText]) -> Dict[str, Any]:
        ...
        total_sentences = sum(ct.metadata.get("sentence_count", 0) for ct in cleaned_texts)
