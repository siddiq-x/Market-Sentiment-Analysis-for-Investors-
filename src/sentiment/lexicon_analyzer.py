...
class FinancialLexiconAnalyzer:
    ...
    def __init__(self):
        ...
        self.negation_words = {
            ...
            'couldnt', 'doesnt', 'dont', 'didnt', 'isnt', 'arent', 'wasnt', 'werent'
        }
    ...
    def _load_additional_lexicons(self):
        ...
        lexicon_dir = os.path.join(os.path.dirname(__file__), '..', '..', 'data', 'lexicons')
    ...
    def analyze_sentiment(self, text: str, context: Optional[Dict[str, Any]] = None) -> LexiconSentimentResult:
        """
    ...
    def _apply_modifiers(self, words: List[str], word_scores: Dict[str, float]) -> Dict[str, float]:
        ...
        for i, word in enumerate(words):
            if word in adjusted_scores:
                ...
                adjusted_scores[word] = max(-2.0, min(2.0, adjusted_scores[word]))
    ...
    def _determine_sentiment(self, word_scores: Dict[str, float]) -> Tuple[str, float]:
        ...
        negative_score = abs(sum(score for score in word_scores.values() if score < 0))
    ...
    def batch_analyze(self, 
                     texts: List[str], 
                     contexts: Optional[List[Dict[str, Any]]] = None) -> List[LexiconSentimentResult]:
