...
class StreamProcessor:
    ...
    def _processing_loop(self):
        ...
        while self.running:
            try:
                ...
                while len(batch) < self.batch_size and (time.time() - start_time) < self.processing_interval:
                    try:
                ...
                if batch:
                    ...
                    for message_type, message in batch:
                        future = self.executor.submit(self._process_message, message_type, message)
    ...
    def get_recent_sentiment_data(self, ticker: str, hours_back: int = 24) -> List[Dict[str, Any]]:
