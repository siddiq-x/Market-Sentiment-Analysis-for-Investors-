...
class MultimodalFusionEngine:
    ...
    def predict(self, feature_set: FeatureSet) -> PredictionResult:
        ...
        # Create data loader
        dataset = FinancialDataset(feature_set.features, np.zeros(len(feature_set.features)))
        data_loader = DataLoader(dataset, batch_size=self.training_config.batch_size, shuffle=False)
